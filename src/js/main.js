...
document.getElementById('input-submit').addEventListener('click', () =>{
    ul_height = Number(document.getElementById('upper-limb-slider').value),
    ...
    if(inputIsValid()){
        ...
        alert('Unsuitable Input Parameters. Retry!');
    }
});
...
function main(){
    ...
    // Physical constants
    var DENSITY = 500,
        UPPER_LEG_RADIUS = ul_height/5 || 0.15, //Currently, radius/height = 1/5, may need better proportion
        UPPER_LEG_HEIGHT = ul_height || 0.75;
        UPPER_LEG_COLOR = "blue",
        LOWER_LEG_RADIUS = ll_height/5 || 0.1, //Currently, radius/height = 1/5, Need to change it, to be smaller than ul radius
        LOWER_LEG_HEIGHT = ll_height || UPPER_LEG_HEIGHT,
    ...
    function initUI() {
        ...
        var exitSimButton = document.getElementById("btn-exit-sim");
        exitSimButton.addEventListener("click", exitSim, false);
    }
